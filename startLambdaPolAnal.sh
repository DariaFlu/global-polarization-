...
CONFIG_DIR="/lhep/users/dflusova/lambda/afterburner/release/" #path to afterburner
SRC_DIR="/lhep/users/dflusova/lambda/afterburner/release/src/" # path to afterburner/src
