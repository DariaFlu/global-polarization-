...
void lambdaPolAnal() {
    ...
    TString pathOut = "/lhep/users/dflusova/lambda/afterburner/v.6/out/processed/"; //out folder
    ...
    TString fileOut = "merged_result_urqmd_xexe_2.87gev_mf_6195240_.mcini.root"; //file for storing produced protons 
    ...
    Int_t enhancedValue = 4; //number of enhanced lambdass
